const brklen_field = document.getElementById('brklen');
const brklen_btn = document.getElementById('brklen_btn');
const brklen_scs = document.getElementById('brklen_scs');
const brklen_err = document.getElementById('brklen_err');

brklen_btn.addEventListener('click', async (event) => {
    const brklen_val = brklen_field.value;
...
// ==================================================================
const brkspch_field = document.getElementById('brkspch');
const brkspch_btn = document.getElementById('brkspch_btn');
const brkspch_scs = document.getElementById('brkspch_scs');
const brkspch_err = document.getElementById('brkspch_err');

brkspch_btn.addEventListener('click', async (event) => {
    const brkspch_val = brkspch_field.value;
...
// ===================================================================
const p_spch_field = document.getElementById('p_spch');
const p_spch_btn = document.getElementById('p_spch_btn');
const p_spch_scs = document.getElementById('p_spch_scs');
const p_spch_err = document.getElementById('p_spch_err');

p_spch_btn.addEventListener('click', async (event) => {
    const p_spch_val = p_spch_field.value;
...
// ===================================================================
const p_len_field = document.getElementById('p_len');
const p_len_btn = document.getElementById('p_len_btn');
const p_len_scs = document.getElementById('p_len_scs');
const p_len_err = document.getElementById('p_len_err');

p_len_btn.addEventListener('click', async (event) => {
    const p_len_val = p_len_field.value;
